...
int32_t Renderer::handleMotionEvent(AInputEvent* event) {
...
int32_t Renderer::handleKeyEvent(AInputEvent* event) {
    ...
    switch (action) {
        ...
        case AKEY_EVENT_ACTION_MULTIPLE:
            ...
            break;
        default:
            aout << "Unknown KeyEvent Action: " << action;
    }
    aout << std::endl;
...
void Renderer::handleInput() {
    android_app* app = (android_app*)app_; // 假设 mApp 存储了 android_app 指针
